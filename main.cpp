...
int randonNumMaxMin(int min, int max)
{
...
int main()
{
    ...
    for (int x = 100, y = 200, i = 20; i > 0; i--)
        for (int j = 15; j > 0; j--)
            myWorld.AddParticle(randonNumMaxMin(10, 25), randonNumMaxMin(20, 250), Myvector(100 + i * (2 * 20 + 10), 200 + j * (2 * 20 + 10)),
    ...
    myWorld.AddParticle(20, 10000, Myvector(340, 0), Myvector(-30, 0)); */
